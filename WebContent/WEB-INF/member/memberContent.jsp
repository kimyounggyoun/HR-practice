  ...
  <div class="panel panel-default">
    <div class="panel-heading">
     <c:if test="${sessionScope.userId!=null && sessionScope.userId!=''}">
       <label>
       		<img src="<c:out value='file_repo/${vo.filename}'/>"  width="40px" height="40px"/>
       ...
       <div class="form-group">
         ...
         <div class="col-sm-10">
           ...
           <c:if test="${vo.filename != null && vo.filename != '' }">
           		<a href="javascript:getfile('${vo.filename }')">
           		<c:out value='${vo.filename }'/></a>
           </c:if>
           <c:if test="${sessionScope.userId != null && sessionScope.userId == vo.id
           				&& vo.filename != null && vo.filename != '' }">
           		<a href="javascript:delfile('${vo.num }','${vo.filename }')">		
